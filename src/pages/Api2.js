...
function Disfraces(){ 
      ...
      return(
        ...
        <center><h2>Tienes {times} producto(s) en tu carrito</h2></center>
        <center><button onClick={()=>setTime(times-times)}>Vaciar carrito?</button></center>
        </body>
      )
  }
